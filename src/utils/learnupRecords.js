...
import { getDepartmentDisplayName } from "./departments.js";
...
const normalizeStudent = (student) => {
  ...
  return {
    ...
    department: getDepartmentDisplayName(student),
...
const normalizeFaculty = (faculty) => {
  ...
  return {
    ...
    facultyId: id,
    instructorId: id,
    backendInstructorId: faculty.backendInstructorId,
    instructor_id: faculty.instructor_id,
    userId: faculty.userId,
    user_id: faculty.user_id,
    universityId: clean(faculty.universityId || faculty.university_id) || id,
    ...
    department: getDepartmentDisplayName(faculty),
    ...
    courseLoad,
    assignedCourses,
    assignedCourseCount: Number.isFinite(Number(faculty.assignedCourseCount))
      ? Number(faculty.assignedCourseCount)
      : assignedCourses.length,
    courses: Array.isArray(faculty.courses)
      ? faculty.courses.map(clean).filter(Boolean)
      : [],
